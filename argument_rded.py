...
parser.add_argument(
    "--train-dir",
    type=str,
    default="/data/wujunyi/dataset/imagenet/images/train/",
...
parser.add_argument("--refine", default=False, action="store_true", help="refined labels and training")
parser.add_argument('--dsa', default=False, action="store_true", help='whether to use differentiable Siamese augmentation.')
